...
export class SampleProductsComponent implements OnInit{
 constructor(private readonly api:HttpService, private readonly http:HttpClient, private readonly route:ActivatedRoute,private toastr: ToastrService){}
...
ngOnInit(): void {
  this.route.params.subscribe((params)=>{
    const url:string="https://63bfcce3e262345656f0627b.mockapi.io/products"
